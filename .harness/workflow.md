...
## Commits / MR
- Plain imperative descriptions are the dominant style (~150 of 203 recent commits); `chore: bump dashboard submodule pointer — <description>` for submodule-bump commits; occasional `feat:`/`fix:`/`docs:` prefixes appear but aren't the norm — *from-codebase*
